...
public class CreateSingleInsuranceWithDebitTestRunner {
	...
	@Test(priority = 1)
	public void testCreateInsuranceWithDebit() {
		...
		objCreateNewInsuranceCheckoutPaymentDebitInfo = new CreateNewInsuranceCheckoutPaymentDebitInfo(driver);
		...
		objCreateNewInsuranceCheckoutPaymentMethod.choosePaymentMethod_debit();
		objCreateNewInsuranceCheckoutPaymentDebitInfo.fillPaymentDebitInfo();
	}
